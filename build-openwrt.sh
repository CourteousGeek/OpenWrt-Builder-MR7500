...
VERSION="25.12.3"
PACKAGES="luci luci-ssl-openssl conntrackd keepalived keepalived-sync luci-app-keepalived -wpad-basic-mbedtls wpad-mesh-openssl kmod-batman-adv luci-proto-batman-adv batctl-full rsync jq pigz tar iperf3 tcpdump"
